...
vim.keymap.set("n", "<C-k>", "<C-w>k", opts, { desc = "Move to panel above" })
vim.keymap.set("n", "<C-j>", "<C-w>j", opts, { desc = "Move to panel below" })
vim.keymap.set("n", "<C-l>", "<C-w>l", opts, { desc = "Move to panel right" })
vim.keymap.set("n", "<C-h>", "<C-w>h", opts, { desc = "Move to panel left" })
